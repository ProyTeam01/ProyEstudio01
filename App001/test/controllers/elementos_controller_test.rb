...
class ElementosControllerTest < ActionController::TestCase
  ...
  test "should create elemento" do
    assert_difference('Elemento.count') do
      post :create, elemento: { content: @elemento.content, createdby: @elemento.createdby, downvote: @elemento.downvote, idPadre: @elemento.idPadre, nivel: @elemento.nivel, titulo: @elemento.titulo, type: @elemento.type, upvote: @elemento.upvote }
    end
  ...
  test "should update elemento" do
    patch :update, id: @elemento, elemento: { content: @elemento.content, createdby: @elemento.createdby, downvote: @elemento.downvote, idPadre: @elemento.idPadre, nivel: @elemento.nivel, titulo: @elemento.titulo, type: @elemento.type, upvote: @elemento.upvote }
    assert_redirected_to elemento_path(assigns(:elemento))
  end
